...
aws sagemaker create-model \
   ...
   --primary-container Image=$IMAGE,Environment='{bucket=23people-model,prefix=sklearn,model=sk-predictor}' \
...
aws sagemaker create-endpoint-config \
   ...
   --production-variants VariantName=SKLearn,ModelName=$MODEL_NAME,InitialInstanceCount=$INITIAL_INSTANCE_COUNT,InstanceType=$INSTANCE_TYPE
